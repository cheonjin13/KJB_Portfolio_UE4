...
#include "KJB_Portfolio/Public/UISlot.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	KJB_PORTFOLIO_API UClass* Z_Construct_UClass_UUISlot_NoRegister();
	KJB_PORTFOLIO_API UClass* Z_Construct_UClass_UUISlot();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UUISlot_Statics::Class_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Public/UISlot.h" },
	};
#endif
	...
	IMPLEMENT_CLASS(UUISlot, 732903183);
	template<> KJB_PORTFOLIO_API UClass* StaticClass<UUISlot>()
	{
		return UUISlot::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UUISlot(Z_Construct_UClass_UUISlot, &UUISlot::StaticClass, TEXT("/Script/KJB_Portfolio"), TEXT("UUISlot"), false, nullptr, nullptr, nullptr);
